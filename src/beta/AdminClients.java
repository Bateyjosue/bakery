...
public class AdminClients extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        saerch_client = new javax.swing.JTextField();
        ...
        jLabel21.setText("Update Client");
        ...
        mail.setFont(new java.awt.Font("Ubuntu", 0, 12)); // NOI18N
        ...
        gender.setFont(new java.awt.Font("Ubuntu", 0, 12)); // NOI18N
        gender.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Other", "Male", "Female" }));
        ...
        saerch_client.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        saerch_client.setForeground(new java.awt.Color(0, 64, 64));
        saerch_client.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 51, 51)));
        saerch_client.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saerch_clientActionPerformed(evt);
            }
        });
        saerch_client.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                saerch_clientKeyReleased(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(saerch_client, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(4, 4, 4)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(saerch_client, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel9)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        gender.getAccessibleContext().setAccessibleDescription("");
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 430, -1, -1));
    ...
    private void saerch_clientKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_saerch_clientKeyReleased
        if (saerch_client.getText().equals("")) {
            tableClients();
        } else {
            try {
                if (!kon.isClosed()) {
                    String query = "SELECT * from tbl_Clients WHERE `full_name` like '%" + saerch_client.getText() + "%'";
                    pst = kon.prepareStatement(query);
    ...
    }//GEN-LAST:event_saerch_clientKeyReleased

    private void tbl_clientMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_clientMouseClicked
                try {
                    TableModel model=tbl_client.getModel();
                    id.setText(model.getValueAt(tbl_client.getSelectedRow(),0).toString());
                    full_name.setText(model.getValueAt(tbl_client.getSelectedRow(),1).toString());
                    mail.setText(model.getValueAt(tbl_client.getSelectedRow(),3).toString());
                    gender.setSelectedItem(model.getValueAt(tbl_client.getSelectedRow(),2).toString());
                    phone.setText(model.getValueAt(tbl_client.getSelectedRow(),4).toString());
                    created_date.setDate(new SimpleDateFormat("yyyy-MM-dd").parse((String)model.getValueAt(tbl_client.getSelectedRow(), 5)));
                }
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        try
        {
            if(!kon.isClosed())
            {
                String s="UPDATE `tbl_Clients` SET `id`='"+id.getText()+"',`full_name`='"+full_name.getText()+"',"
                        + "`gender`='"+gender.getSelectedItem()+"', `mail`='"+mail.getText()+"', "
                        + "`phone`='"+phone.getText()+"', `created_at`= now() WHERE `id`='"+id.getText()+"'";
    ...
    private void saerch_clientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saerch_clientActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_saerch_clientActionPerformed
    ...
    private javax.swing.JTextField saerch_client;
